...
% sh deploy_mac.sh
% ~/bin/butler login
% ~/bin/butler push src-tauri/target/release/bundle/dmg/tetorica-deskel_0.11.8_aarch64.dmg kyorohiro/tetorica-deskel:mac-apple-silicon --userversion 0.11.8

% ~/bin/butler push src-tauri/target/x86_64-apple-darwin/release/bundle/dmg/tetorica-deskel_0.11.8_x64.dmg kyorohiro/tetorica-deskel:mac-intel --userversion 0.11.8

% ~/bin/butler push "src-tauri/target/release/bundle/nsis/tetorica-deskel_0.11.8_x64-setup.exe" kyorohiro/tetorica-deskel:windows --userversion 0.11.8
```
